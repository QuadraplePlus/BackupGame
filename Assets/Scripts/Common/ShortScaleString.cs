...
public class ShortScaleString : MonoBehaviour {
    ...
    */
    ...
    /// </summary>
    static string[] ShortScaleSymbolReference = { "a", "b", "c", "d", "e", "f", "g", "h","i","j","k","l","n","m","o",
    ...
    /// </param>
    public static string parseDouble(double value,int precision = 3, double startShortScale = 1000, bool useSymbol = false){
		int index = -1;
        int isNegative = 1;
    ...
    /// (Optional) use the single symbol list for more shortened notation. currently supports only to Decillion.
    /// </param>
	public static string parseInt(long value, int precision = 3, int startShortScale = 1000000, bool useSymbol = false){
		int index = -1;
		int isNegative = 1;
		string addPrecision = new string ('#', precision);
